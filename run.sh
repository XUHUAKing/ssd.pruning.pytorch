...
python3 train_vgg.py --dataset WEISHI --jpg_xml_path '/cephfs/share/data/weishi_xh/train_58_0713.txt' --label_name_path '/cephfs/share/data/weishi_xh/label58.txt' --num_workers 8
