...
#             conv_dw(512, 1024, 2),
            conv_dw(1024, 1024, 1),# source for detection here -- index = 13
            nn.AvgPool2d(7), # this will shrink image size from 7x7 to 1x1
        )
    ...
    def mobilev1_layers(self):
        ...
        return layers[:-1] # exclude the last layer
